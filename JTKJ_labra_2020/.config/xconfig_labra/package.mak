...
package/%.xdc.inc package/%_xconfig_labra.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_labra" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em3 .dlls: labra.pem3

-include package/cfg/labra_pem3.mak
-include package/cfg/labra_pem3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/labra_pem3.dep
endif
labra.pem3: package/cfg/labra_pem3.xdl
	@


ifeq (,$(wildcard .libraries,em3))
labra.pem3 package/cfg/labra_pem3.c: .libraries,em3
endif

package/cfg/labra_pem3.c package/cfg/labra_pem3.h package/cfg/labra_pem3.xdl: override _PROG_NAME := labra.xem3
package/cfg/labra_pem3.c: package/cfg/labra_pem3.cfg
package/cfg/labra_pem3.xdc.inc: package/cfg/labra_pem3.xdl
package/cfg/labra_pem3.xdl package/cfg/labra_pem3.c: .interfaces

clean:: clean,em3
	-$(RM) package/cfg/labra_pem3.cfg
	-$(RM) package/cfg/labra_pem3.dep
	-$(RM) package/cfg/labra_pem3.c
	-$(RM) package/cfg/labra_pem3.xdc.inc

clean,em3::
	-$(RM) labra.pem3
.executables,em3 .executables: labra.xem3

labra.xem3: |labra.pem3

-include package/cfg/labra.xem3.mak
labra.xem3: package/cfg/labra_pem3.oem3 
	$(RM) $@
	@$(MSG) lnkem3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M3.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M3 -z --strict_compatibility=on  -o $@ package/cfg/labra_pem3.oem3   package/cfg/labra_pem3.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M3.rootDir)/lib/libc.a
	
labra.xem3: export C_DIR=
labra.xem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)
labra.xem3: Path:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)

labra.test test,em3 test: labra.xem3.test

labra.xem3.test:: labra.xem3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 labra.xem3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.labra.xem3, ) 
endif

clean,em3::
	-$(RM) $(wildcard .tmp,labra.xem3,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
labra_pem3.oem3,copy : package/cfg/labra_pem3.oem3
labra_pem3.sem3,copy : package/cfg/labra_pem3.sem3

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_labra
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_labra.tar.dep
endif
package/rel/xconfig_labra/xconfig_labra/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_labra/xconfig_labra/package/package.rel.xml: package/build.cfg
package/rel/xconfig_labra/xconfig_labra/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_labra/xconfig_labra/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_labra.tar: package/rel/xconfig_labra.xdc.inc package/rel/xconfig_labra/xconfig_labra/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_labra.xdc.inc,package/rel/xconfig_labra.tar.dep)


release release,xconfig_labra: all xconfig_labra.tar
clean:: .clean
	-$(RM) xconfig_labra.tar
	-$(RM) package/rel/xconfig_labra.xdc.inc
	-$(RM) package/rel/xconfig_labra.tar.dep
